---
name: no-use-effect
description: Never call useEffect directly. Use derived state, event handlers, data-fetching libraries, or useMountEffect instead. Use when writing new React components, refactoring existing useEffect calls, reviewing PRs that introduce useEffect, or when an agent adds useEffect.
---
